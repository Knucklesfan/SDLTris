...
nullscene.o: source/scenes/nullscene.cpp
	$(CC) $(FLAGS) source/scenes/nullscene.cpp
modifiers.o: source/gameplay/modifiers.cpp
	$(CC) $(FLAGS) source/gameplay/modifiers.cpp
combonumber.o: source/gameplay/combonumber.cpp
	$(CC) $(FLAGS) source/gameplay/combonumber.cpp
